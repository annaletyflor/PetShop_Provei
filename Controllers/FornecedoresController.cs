...
namespace PetShop_Provei.Controllers
{
    public class FornecedoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nome_Empresa,CNPJ,Endereco,Telefone")] Fornecedor fornecedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,Nome_Empresa,CNPJ,Endereco,Telefone")] Fornecedor fornecedor)
        {
            if (id != fornecedor.ID)
            {
                return NotFound();
